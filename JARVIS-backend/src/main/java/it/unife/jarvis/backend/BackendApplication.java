...
public class BackendApplication {
	...
	public CommandLineRunner run(RESTConsumer consumer) throws Exception {
		return args -> {
			EventInfo output = consumer.consumeRESTParse("http://mock:3000/api/mock_supplier", EventInfo.class); //https://3d4b2335-1631-475f-ab52-03bf26a3d594.mock.pstmn.io/test
